<template>
  <v-card 
    ...
    <v-card-subtitle class="pa-0 ma-0">
      <p class="text-title-2 text-center pa-0 ma-0" style="word-break: normal;">{{credit.name}}</p>
      <p class="text-subtitle-4  text-center pa-0 ma-0" style="word-break: normal;">{{credit.character}}</p>
    </v-card-subtitle>
